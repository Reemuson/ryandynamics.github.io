...
description: Terms applying to use of the Ryan Dynamics website.
...
<article class="page legal-document" aria-labelledby="website-terms-title" markdown="1">

# Website Terms of Use
{: #website-terms-title }

<div class="legal-dates" markdown="1">
...
These terms apply to your use of the Ryan Dynamics website. By using the website, you agree to these terms. If you do not agree, please do not use the website.

Ryan Dynamics (ABN 18 531 301 208) is a sole-trader business based in Newcastle, New South Wales.
...
You should obtain project-specific advice and carry out appropriate design review, risk assessment, testing, validation and regulatory assessment before relying on any technical work.
...
Unless stated otherwise, Ryan Dynamics owns or is licensed to use the website's text, branding, graphics, photographs, drawings, renders, software and other content.

You may view the website and make incidental copies created by an ordinary web browser for personal or internal business evaluation. You must not otherwise reproduce, modify, publish, distribute, sell, reverse engineer or commercially exploit website content without prior written permission or another legal right to do so.

Project examples do not grant any licence to manufacture a depicted item, reproduce a design, use source files or apply another client's project deliverables. Third-party names, marks and content remain the property of their respective owners.

## Third-party materials

This website uses icons from [Lucide](https://lucide.dev/) under the ISC License. Some Lucide icons are derived from Feather and remain subject to the MIT License. Those materials remain subject to their respective licence terms. The applicable notices are available in the [Lucide and Feather licence file]({{ '/assets/legal/lucide-license.txt' | relative_url }}).
...
The [Privacy Policy]({{ '/privacy/' | relative_url }}) explains how Ryan Dynamics handles personal information collected through the website and related communications.
...
Questions about these terms can be submitted through the [contact form]({{ '/contact/' | relative_url }}).
